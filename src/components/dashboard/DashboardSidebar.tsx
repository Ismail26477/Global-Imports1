...
export function DashboardSidebar({ collapsed, setCollapsed, isMobileDrawer = false }: DashboardSidebarProps) {
    ...
    >
      ...
      <div className="flex items-center justify-between h-16 px-4 border-b border-sidebar-border">
        <Link to="/" className="flex items-center gap-3">
          ...
          {!collapsed && (
            <span className="font-bold text-lg text-sidebar-accent-foreground">{APP_CONFIG.sidebarName}</span>
          )}
        </Link>
        {!isMobileDrawer && (
          <button
