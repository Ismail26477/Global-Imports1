...
export function KPICard({
  ...
  return (
    <div
      className={cn(
        "bg-card rounded-lg sm:rounded-xl border border-border p-3 sm:p-4 lg:p-5 shadow-sm hover:shadow-md transition-all duration-300 animate-fade-in",
        className,
      )}
    >
      ...
      <p className="text-xs text-muted-foreground mt-2 sm:mt-3">{changeLabel}</p>
    </div>
  )
}
