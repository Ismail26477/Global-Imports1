...
import { useShipments, usePendingFulfillment } from "@/hooks/useMongoDB";

const Fulfillment = () => {
  const [searchQuery, setSearchQuery] = useState("");
  
  const { data: shipments = [], isLoading: shipmentsLoading } = useShipments();
  const { data: pendingOrders = [], isLoading: pendingLoading } = usePendingFulfillment();
  ...
  const isLoading = shipmentsLoading || pendingLoading;
