...
import { useTransactions, useRefunds } from "@/hooks/useMongoDB";
...
const Payments = () => {
  ...
  const isLoading = transactionsLoading || refundsLoading;
              ...
              <CardContent>
                <div className="text-center py-12">
                  ...
                  <div className="mt-6 p-4 bg-muted rounded-lg max-w-sm mx-auto">
                    <p className="text-sm text-muted-foreground">Next Payout Amount</p>
